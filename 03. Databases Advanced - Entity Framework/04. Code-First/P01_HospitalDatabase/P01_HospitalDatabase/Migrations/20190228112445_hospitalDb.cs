        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientId = table.Column<int>(nullable: false),
                    MedicamentId = table.Column<int>(nullable: false),
                    FK_PatientsMedicaments_Patients = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientsMedicaments", x => new { x.PatientId, x.MedicamentId });
                    table.ForeignKey(
                        name: "FK_PatientsMedicaments_Patients_FK_PatientsMedicaments_Patients",
                        column: x => x.FK_PatientsMedicaments_Patients,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientsMedicaments_FK_PatientsMedicaments_Patients",
                table: "PatientsMedicaments",
                column: "FK_PatientsMedicaments_Patients");
